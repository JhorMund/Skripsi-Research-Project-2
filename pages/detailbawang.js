...
import bawang from "assets/img/product/bawang1.jpg";
      ...
      <div>
        ...
        <div className={classNames(classes.main, classes.mainRaised)}>
          ...
          <Link href="/">
            ...
            <Typography color="textPrimary">Bawang</Typography>
          </Breadcrumbs> 
            <div className={classes.container}>
              <GridContainer justify="left">
                <GridItem xs={12} sm={12} md={6}>
                  <div className={classes.bawang}>
                    <div>
                      <br/>
                      <img src={bawang} alt="..." className={classes.imgRounded + " " + classes.imgFluid} />
                    </div>
                    <br/><br/>
                  </div>
                </GridItem>
                ...
                <br/><br/><br/>
                    <div className={classes.name}>
                      <h3 className={classes.title}>Bawang</h3>
                      <h6>
