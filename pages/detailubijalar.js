...
import ubijalar from "assets/img/product/ubijalar1.jpg";
    ...
    <div>
      ...
      <div className={classNames(classes.main, classes.mainRaised)}>
        ...
        <Breadcrumbs aria-label="breadcrumb">
          ...
          <Typography color="textPrimary">Ubi Jalar</Typography>
        </Breadcrumbs>
          <div className={classes.container}>
            <GridContainer justify="left">
              <GridItem xs={12} sm={12} md={6}>
                <div className={classes.ubijalar}>
                  <div>
                    <br/>
                    <img src={ubijalar} alt="..." className={classes.imgRounded + " " + classes.imgFluid} />
                  </div>
                  <br/><br/>
                </div>
              </GridItem>
              ...
              <br/><br/><br/>
                  <div className={classes.name}>
                    <h3 className={classes.title}>Ubi Jalar</h3>
                    <h6>
