...
import kayumanis from "assets/img/product/kayumanis1.jpg";
    ...
    <div>
      ...
      <div className={classNames(classes.main, classes.mainRaised)}>
        ...
        <Breadcrumbs aria-label="breadcrumb">
          ...
          <Typography color="textPrimary">Kayu Manis</Typography>
        </Breadcrumbs>
          <div className={classes.container}>
            <GridContainer justify="left">
              <GridItem xs={12} sm={12} md={6}>
                <div className={classes.kayumanis}>
                  <div>
                    <br/>
                    <img src={kayumanis} alt="..." className={classes.imgRounded + " " + classes.imgFluid} />
                  </div>
                  <br/><br/>
                </div>
              </GridItem>
              ...
              <GridItem xs={12} sm={12} md={6}>
                <br/><br/><br/>
                  <div className={classes.name}>
                    <h3 className={classes.title}>Kayu Manis</h3>
                    <h6>
